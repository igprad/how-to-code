...
__global__ void sum_csv_data_with_cuda(double *first_row, double *second_row, double *third_row) {
    return;
}

__device__ double sum(double first_val, double second_val, third_val) {
